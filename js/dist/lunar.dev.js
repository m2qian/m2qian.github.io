...
var calendarFormatter = {
  solar2lunar: function solar2lunar(b, f, c) {
    return _solar2lunar(b, f, c);
  },
  lunar2solar: function lunar2solar(b, f, c, e) {
    ...
    return _solar2lunar(o.getUTCFullYear(), o.getUTCMonth() + 1, o.getUTCDate());
  }
};